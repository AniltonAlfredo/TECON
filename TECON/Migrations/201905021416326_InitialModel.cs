namespace TECON.Migrations
{
    ...
    public partial class InitialModel : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Pagamentoes", "Tipo_Id", "dbo.Tipoes");
            DropForeignKey("dbo.Pagamentoes", "Cliente_Id", "dbo.Clientes");
            ...
            DropIndex("dbo.Pagamentoes", new[] { "Tipo_Id" });
            DropIndex("dbo.Pagamentoes", new[] { "Cliente_Id" });
